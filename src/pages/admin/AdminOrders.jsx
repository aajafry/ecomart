...
function AdminOrders() {
  ...
  const handleUpdateOrderStatus = useCallback((updatedOrderId) => {
    setOrderIdToUpdateStatus(updatedOrderId);
    openVisibility("UPDATE");
  }, [openVisibility]);

  const handleAcceptRefundOrder = useCallback((refundedOrderId) => {
    setOrderIdToacceptRefund(refundedOrderId);
    openVisibility("REFUND");
  }, [openVisibility]);


  const handleCancelOrder = useCallback((canceledId) => {
